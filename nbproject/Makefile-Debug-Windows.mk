...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk debug.exe

debug.exe: ${OBJECTFILES}
	${LINK.cc} -o debug.exe ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/source/character.o: source/character.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_IRR_STATIC_LIB_ -I../../../libraries/irrlicht-1.8.3/include -I../../../libraries/sqlite-3.8.4.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/character.o source/character.cpp
...
${OBJECTDIR}/source/day.o: source/day.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_IRR_STATIC_LIB_ -I../../../libraries/irrlicht-1.8.3/include -I../../../libraries/sqlite-3.8.4.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/day.o source/day.cpp
...
${OBJECTDIR}/source/user.o: source/user.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_IRR_STATIC_LIB_ -I../../../libraries/irrlicht-1.8.3/include -I../../../libraries/sqlite-3.8.4.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/user.o source/user.cpp

${OBJECTDIR}/source/world.o: source/world.cpp 
	${MKDIR} -p ${OBJECTDIR}/source
	${RM} "$@.d"
	$(COMPILE.cc) -g -D_IRR_STATIC_LIB_ -I../../../libraries/irrlicht-1.8.3/include -I../../../libraries/sqlite-3.8.4.2/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/source/world.o source/world.cpp
